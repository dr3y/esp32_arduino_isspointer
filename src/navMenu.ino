/* 
  ...
  menu using physical buttons and a physical OLED display.
  Code edited by Andrey Shur 2020
...
idx_t tops[MAX_DEPTH] = {0, 0}; //store cursor positions for each level
 outOLED(&display, tops, pList, 8, 1+((fontH-1)>>3) ); //oled output device menu driver
